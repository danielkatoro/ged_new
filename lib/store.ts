        ...
        armoires: [
          {
            ...
            dossiers: [
              {
                id: "doss-rh-contrats",
                name: "Contrats Emploi",
                date: "15-03-2026",
                description: "Contrats de travail des employes",
                files: [
                  {
                    id: "doc-rh-001",
                    name: "Contrat_CDI_M_Brou.pdf",
                    type: "pdf",
                    size: "420 KB",
                    date: "15-03-2026",
                    status: "Approuve",
                    confidence: 98,
                    author: "M. Brou",
                    description: "Contrat de travail CDI pour le responsable d agence",
                    tags: ["contrat", "emploi", "cdi"],
                    source: "upload",
                    versions: createVersions(1),
                    activity: createActivity(["Signe"]),
                  },
                  {
                    id: "doc-rh-002",
                    name: "Contrat_CDD_Stage_2026.pdf",
                    type: "pdf",
                    size: "380 KB",
                    date: "01-04-2026",
                    status: "Approuve",
                    confidence: 95,
                    author: "RH",
                    description: "Contrat de stage 2026",
                    tags: ["contrat", "stage", "etudiant"],
                    source: "upload",
                    versions: createVersions(1),
                    activity: createActivity(["Signe"]),
                  },
              ...
              },
              {
                ...
                files: [
                  {
                    id: "doc-rh-003",
                    name: "Bulletin_Paie_Avril_2026.pdf",
                    type: "pdf",
                    size: "240 KB",
                    date: "25-04-2026",
                    status: "Approuve",
                    confidence: 97,
                    author: "Comptabilite",
                    description: "Bulletin de paie avril 2026",
                    tags: ["paie", "avril", "2026"],
                    source: "workflow",
                    versions: createVersions(1),
        ...
        armoires: [
          {
            ...
            dossiers: [
              {
                id: "contrats-clients-2026",
                name: "Contrats Clients 2026",
                date: "01-04-2026",
                description: "Contrats commerciaux avec les clients actifs",
                files: [
                  {
                    id: "doc-bcg-001",
                    name: "Contrat_Societe_Generale_2026.pdf",
                    type: "pdf",
                    size: "1.5 MB",
                    date: "20-04-2026",
                    status: "Approuve",
                    confidence: 99,
                    author: "K. Assi",
                    description: "Contrat annuel avec Societe Generale pour services bancaires",
                    tags: ["contrat", "banque", "sg", "2026"],
                    source: "email",
                    versions: createVersions(2),
                    activity: createActivity(["Approuve", "Revise"]),
                  },
                  {
                    id: "doc-bcg-002",
                    name: "Contrat_Fournisseur_BTP.pdf",
                    type: "pdf",
                    size: "980 KB",
                    date: "18-04-2026",
                    ...
                    confidence: 93,
                    author: "Systeme",
                    description: "Contrat de fourniture de materiel BTP",
                    tags: ["contrat", "fournisseur", "btp"],
                    source: "upload",
                    versions: createVersions(1),
                    activity: createActivity(["Importe"]),
                  },
                ],
              },
              {
                ...
                date: "01-02-2026",
                description: "Accords commerciaux avec nos fournisseurs",
                files: [
                  {
                    id: "doc-bcg-003",
                    name: "Accord_Livraison_Electrique.pdf",
                    type: "pdf",
                    size: "750 KB",
                    date: "10-02-2026",
                    status: "Approuve",
                    confidence: 96,
                    author: "K. Assi",
                    description: "Accord de livraison exclusif avec societe electrique",
                    tags: ["accord", "energie", "livraison"],
                    source: "workflow",
            ...
            dossiers: [
              {
                ...
                name: "Serveurs",
                date: "20-03-2026",
                description: "Documentation des serveurs et infrastructure",
                files: [
                  {
                    id: "doc-it-001",
                    name: "Spec_Serveurs_Production.pdf",
                    type: "pdf",
                    size: "1.1 MB",
                    date: "20-03-2026",
                    status: "Approuve",
                    confidence: 99,
                    author: "T. Goli",
                    description: "Specifications techniques des serveurs production",
                    tags: ["infrastructure", "serveurs", "production"],
                    source: "upload",
                    versions: createVersions(2),
                    activity: createActivity(["Approuve", "Cree"]),
                  },
                  {
                    ...
                    confidence: 92,
                    author: "T. Goli",
                    description: "Politique de sauvegarde IT 2026",
                    tags: ["backup", "securite", "it"],
                    source: "upload",
                    versions: createVersions(1),
                    activity: createActivity(["Approuve"]),
                  },
                ],
              },
              {
                ...
                date: "10-03-2026",
                description: "Licences et contrats logiciels",
                files: [
                  {
                    id: "doc-it-003",
                    name: "Licence_Microsoft_365.pdf",
                    type: "pdf",
                    size: "650 KB",
                    date: "10-03-2026",
                    status: "Approuve",
                    confidence: 98,
                    author: "Systeme",
                    description: "Contrat de licence Microsoft 365 entreprise",
                    tags: ["licence", "microsoft", "cloud"],
                    source: "email",
                    versions: createVersions(1),
                    activity: createActivity(["Recu"]),
                  },
                ],
              },
            ],
